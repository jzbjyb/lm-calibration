...
./finetune.sh $tpu 3B 3B_softmax softmax uq_clean_train_ol_mix train mc &> output/log/ft_3B_mc_softmax.out
./finetune.sh $tpu 3B 3B_margin margin uq_clean_train_ol_mix train mc &> output/log/ft_3B_mc_margin.out
